...

{
    ...
    public function execute()
    {
        ...
        $imageUploadId = $this->getRequest()->getParam('param_name', 'icon');
        // echo "<pre>";
        // print_r($imageUploadId);
        // die;
        try {
            ...
            $mediaRootDir = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'attachment/' . $firstName . '/' . $secondName . '/';
            // echo $basePath;
            // echo $mediaRootDir;
            ...
            $imageResult['url'] = $mediaUrl . 'attachment/' . $firstName . '/' . $secondName . '/'. $newImageName;
        } catch (\Exception $e) {
